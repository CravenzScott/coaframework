RegisterServerEvent('CashoutCore:DebugSomething')
AddEventHandler('CashoutCore:DebugSomething', function(resource, obj, depth)
...
CashoutCore.Debug = function(resource, obj, depth)
    TriggerEvent('CashoutCore:DebugSomething', resource, obj, depth)
end

CashoutCore.ShowError = function(resource, msg)
    print("\x1b[31m["..resource..":ERROR]\x1b[0m "..msg)
end

CashoutCore.ShowSuccess = function(resource, msg)
